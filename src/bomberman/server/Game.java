...
public class Game implements Serializable {
    ...
    private final List<Session> playerSessions           = new ArrayList<Session>();
    private final List<Player>  players                  = new ArrayList<Player>();
    private final List<Session> spectSessions            = new ArrayList<Session>();
    ...
    public Game(String name, Session creator) {
        ...
        this.playground = new Playground(Playground.DEFAULT_WIDTH,
                Playground.DEFAULT_HEIGHT);
    }
